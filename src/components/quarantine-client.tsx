...
import type { Product, PriceEntry, AnomalyRecord, AnomalyType } from "@/types";
import {
  ShieldAlert,
  AlertTriangle,
  TrendingUp,
...
interface QuarantineClientProps {
  products: Product[];
        ...
        <Card>
          <CardContent className="p-4 text-center">
            ...
            <p className="text-2xl font-bold text-slate-900 dark:text-white">
              {priceEntries.length > 0 ? Math.round((quarantinedEntries.length / priceEntries.length) * 100) : 0}%
            </p>
